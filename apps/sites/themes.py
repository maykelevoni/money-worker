...
THEMES = {
    "minimal": {
        "fonts_url": _FONTS.format("family=Inter:wght@400;500;600;700;800;900"),
    ...
    "bold": {
        "fonts_url": _FONTS.format("family=Poppins:wght@600;700;800;900&family=Inter:wght@400;500;600"),
    ...
    "editorial": {
        "fonts_url": _FONTS.format("family=Playfair+Display:wght@600;700;800&family=Source+Serif+4:wght@400;500;600"),
    ...
    "warm": {
        "fonts_url": _FONTS.format("family=Fraunces:opsz,wght@9..144,500;9..144,600;9..144,700&family=Nunito:wght@400;500;600;700"),
    ...
    "tech": {
        "fonts_url": _FONTS.format("family=Space+Grotesk:wght@500;600;700&family=IBM+Plex+Sans:wght@400;500;600"),
